...
from efficientvit.diffusion_model_zoo import MAE_Diffusion_HF, create_maetok_diffusion_model_cfg
...
def main():
    ...
    evaluator_cfg = OmegaConf.merge(evaluator_cfg, OmegaConf.structured(create_maetok_diffusion_model_cfg(cfg.model)))
    ...
    dc_ae_diffusion = MAE_Diffusion_HF(f'{cfg.model}') # DCAE_Diffusion_HF.from_pretrained(f"mit-han-lab/{cfg.model}")
